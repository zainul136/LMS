					...
					<table class="table style-1" id="ListDatatableView">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<div class="media style-1">
										<span class="icon-name me-2 bgl-success text-success">r</span>
										<div class="media-body">
											<h6>Roberto Cr.</h6>
											<span>roberto@gmail.com</span>
										</div>
									</div>
								</td>
								<td>
							...
							<tr>
								...
								<td>
									<div class="media style-1">
										...
										<div class="media-body">
											<h6>Tonni Sblak</h6>
											<span>tonnisblak@gmail.com</span>
										</div>
									</div>
								</td>
								<td>
							...
							<tr>
								...
								<td>
									<div class="media style-1">
										<span class="icon-name me-2 bgl-danger text-danger">k</span>
										<div class="media-body">
											<h6>Keanu Repes</h6>
											<span>keanurepes@gmail.com</span>
										</div>
									</div>
								</td>
								<td>
