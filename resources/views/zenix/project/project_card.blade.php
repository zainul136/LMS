			...
			<div class="col-xl-6 col-lg-12">
				<div class="card project-card">
					<div class="card-body">
						<div class="d-flex mb-4 align-items-start">
							<div class="dz-media me-3">
								<img src="images/logos/pic2.jpg" class="img-fluid" alt="">
							</div>
							<div class="me-auto">
								<p class="text-primary mb-1">#P-000441425</p>
								<h5 class="title font-w600 mb-2"><a href="{!! url('/post-details'); !!}" class="text-black">Redesign Zenix Mobile App</a></h5>
					...
					<div class="card-body">
						...
						<div class="row mt-4">
							...
							<div class="col-6">
								...
								<div class="progress ">
									<div class="progress-bar bg-primary progress-animated" style="width: 75%; height:6px;" role="progressbar"></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card-body">
						...
						<div class="row">
							...
							<div class="col-6">
								...
								<div class="progress ">
									<div class="progress-bar bg-warning progress-animated" style="width: 75%; height:6px;" role="progressbar"></div>
								</div>
							</div>
						</div>
					</div>
