                            ...
                            <div class="col-lg-12">
                                ...
                                <div class=" row">
                                    <div class="col-md-2 col-sm-4 col-6">
										<span class="data-attr" data-peity='{ "fill": ["rgb(235, 129, 83)", "rgba(235, 129, 83, .5)"], "innerRadius": 10, "radius": 40 }'>1/7</span>
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-6 mt-3 mt-md-0"><span class="data-attr" data-peity='{ "fill": ["rgb(100, 24, 195)", "rgba(100, 24, 195, .5)"], "innerRadius": 14, "radius": 36 }'>2/7</span>
                                    </div>
                                    ...
                                    <div class="col-md-2 col-sm-4 col-6 mt-3 mt-md-0"><span class="data-attr" data-peity='{ "fill": ["rgb(81, 166, 245)", "rgba(81, 166, 245, .5)"],  "innerRadius": 18, "radius": 28 }'>4/7</span>
                                    </div>
                                    ...
                                    <div class="col-md-2 col-sm-4 col-6 mt-3 mt-md-0"><span class="data-attr" data-peity='{ "fill": ["#51A6F5", "rgba(36, 54, 92, .1)"], "innerRadius": 18, "radius": 20 }'>6/7</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body pb-0">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 pb-4">
                                ...
                                <div class="px-4"><span class="bar" data-peity='{ "fill": ["rgb(235, 129, 83)", "rgba(235, 129, 83, .5)"]}'>6,2,8,4,3,8,1,3,6,5,9,2,8,1,4,8,9,8,2,1</span>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 pb-4">
                                <h4 class="card-title mb-4">Bar Chart</h4>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-0">
                                ...
                                <div class=""><span class="donut" data-peity='{ "fill": ["rgb(235, 129, 83)", "rgba(235, 129, 83, .5)"]}'>5/8</span>
                                </div>
                            </div>
                            <div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-0">
                                <h4 class="card-title mb-4">Donut 2</h4>
                                <div class=""><span class="donut" data-peity='{ "fill": ["rgb(100, 24, 195)", "rgba(100, 24, 195, .5)"]}'>250/650</span>
                                </div>
                            </div>
                            <div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-0">
                            ...
                            <div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-0">
                                ...
                                <div class=""><span class="donut" data-peity='{ "fill": ["rgb(81, 166, 245)", "rgba(81, 166, 245, .5)", "rgba(81, 166, 245, .3)",]}'>1,4,5</span>
                                </div>
                            </div>
                            <div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-0">
                            ...
                            <div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-0">
                                ...
                                <div class=""><span class="donut" data-peity='{ "fill": ["#51A6F5", "rgba(36, 54, 92, .1)"]}'>0.52,1.041</span>
                                </div>
                            </div>
                        </div>
                    </div>
